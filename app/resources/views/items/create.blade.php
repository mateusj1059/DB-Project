            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('items.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nombre_item" value="{{ old('nombre_item') }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="stack_maximo" value="{{ old('stack_maximo') }}"
                               class="w-full border border-gray-300 rounded p-2">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="id_rareza" class="w-full border border-gray-300 rounded p-2">
                            ...
                            @foreach($rarezas as $rareza)
                                <option value="{{ $rareza->id_rareza }}">{{ $rareza->nombre_rareza }}</option>
                            @endforeach
                        </select>
                    </div>
