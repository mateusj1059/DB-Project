<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editar Dominio</h2>
    </x-slot>
    <div class="py-12">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('dominios.update', $dominio->id_dominio) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nombre_dominio" value="{{ old('nombre_dominio', $dominio->nombre_dominio) }}"
